...
QT_MOC_LITERAL(1, 16, 11), // "pathChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "path"

    },
    "FileSystemModel\0pathChanged\0\0path"
};
...
void FileSystemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileSystemModel::pathChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileSystemModel::pathChanged(const QString & _t1)
{
