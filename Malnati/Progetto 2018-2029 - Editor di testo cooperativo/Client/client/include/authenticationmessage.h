...
class AuthenticationMessage : public Message
{
    public:
        ...
        AuthenticationMessage( const int clientId, const QString& userName, const EventType eventType, const QString& password, int icon, const bool operationSuccess, const QString& serverMessage );
